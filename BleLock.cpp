...
public:
  ...
  void onPassKeyNotify(uint32_t passKey) override { Serial.print("BLE passkey: "); Serial.println(passKey); }
  bool onSecurityRequest() override { return true; }
  bool onConfirmPIN(uint32_t pin) override { Serial.print("BLE confirm PIN: "); Serial.println(pin); return true; }
